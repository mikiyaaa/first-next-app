  ...
  return (
    <>
      <div className={classes.grid}>
        ...
        >
          <h2>Examples &rarr;</h2>
  className={classes.title}         <p className={classes.description}>Discover and deploy boilerplate example Next.js projects.</p>
        </a>
        ...
        >
          <h2>Deploy &rarr;</h2>
  className={classes.title}         <p className={classes.description}>
